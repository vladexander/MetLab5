...
e=1;
disp('---------------------------------------------------------------------------');
disp('Formaulas de cada iteracion');
disp('---------------------------------------------------------------------------');
fprintf('\n')
...
for j=a:h:(b-h)
   ...
   fprintf('\n');
   fprintf('- K2 = %1.15f * f(%1.15f + %1.15f , w%1.0f + %1.15f)',h,t(i),h/4,i-1,double(k1)/4);
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K3 = %1.15f * f(%1.15f + %1.15f , w%1.0f + %1.15f + %1.15f)',h,t(i),((3/8)*h),i-1,(3*(double(k1))/32),(9*(double(k2))/32));
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K4 = %1.15f * f(%1.15f + %1.15f , w%1.0f + %1.15f - %1.15f + %1.15f)',h,t(i),((12/13)*h),i-1,(1932*(double(k1))/2197),(7200*(double(k2))/2197),(7296*(double(k3))/2197));
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K5 = %1.15f * f(%1.15f + %1.15f , w%1.0f + %1.15f - %1.15f + %1.15f - %1.15f)',h,t(i),h,i-1,(439*(double(k1))/216),(8*(double(k2))),(3680*(double(k3))/513),(845*(double(k3))/4104));
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- w%1.0f = w%1.0f + %1.15f + %1.15f + %1.15f - %1.15f',i,i-1,(25/216)*double(k1),(1408/2565)*double(k3),(2197/4104)*double(k4),(1/5)*double(k5))
   fprintf('\n');
...
for k1=0:k3
   k2=k1+1;
   fprintf('\n');
   fprintf('              %1.0f        %10.15f        %10.15f         %10.15f          %10.15f',k(k2),q(k2),w(k2),v(k2),abs(w(k2)-v(k2)));
   fprintf('\n');                                      
end
